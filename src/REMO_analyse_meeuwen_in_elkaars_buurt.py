...
def HeatmapBuren(mergeddf, buren):
    ...
    buren.rename(columns = {('Catia', 'Eva'): 'voorwaarde1', ('Catia', 'Joanna'): 'voorwaarde2', ('Catia', 'Louise'): 'voorwaarde3', ('Catia', 'Suk-hyo'): 'voorwaarde4', ('Eva', 'Joanna'): 'voorwaarde5', ('Eva', 'Louise'): 'voorwaarde6', ('Eva', 'Suk-hyo'): 'voorwaarde7', ('Joanna', 'Louise'): 'voorwaarde8', ('Joanna', 'Suk-hyo'): 'voorwaarde9', ('Louise', 'Suk-hyo'): 'voorwaarde10'}, inplace = True)
...
def REMO(heatmap):
    ...
    selectie = gesorteerd[(gesorteerd['voorwaarde1'] == True) & (gesorteerd['voorwaarde2'] == True) & (gesorteerd['voorwaarde3'] == True) & (gesorteerd['voorwaarde4'] == True) & (gesorteerd['voorwaarde5'] == True) & (gesorteerd['voorwaarde6'] == True) & (gesorteerd['voorwaarde7'] == True) & (gesorteerd['voorwaarde8'] == True) & (gesorteerd['voorwaarde9'] == True) & (gesorteerd['voorwaarde10'] == True)]
...
dfdict, meeuwen = ReadData(r'C:\Users\User\Documents\2e master geografie\projectwerk geo-ict\puntenhighres.csv')
freq = '1S'
buffer = 500
